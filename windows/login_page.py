...
import windows.face_recognition_login as face_recognition_login
import windows.register_page as register_page
...
class LoginPage(tk.Frame):
    def __init__(self, master):
        ...
        register_button = tk.Button(self, text='Register', command=lambda: master.switch_frame(
            register_page.RegisterPage), width=10,
                                    font=('Arial', 10))
